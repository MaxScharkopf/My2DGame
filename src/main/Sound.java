...
public class Sound {
    ...
    public Sound() {
        ...
        soundURL[7] = getClass().getResource("/sound/weapon_sound/sword_swing_1.wav");
        soundURL[8] = getClass().getResource("/sound/weapon_sound/sword_swing_2.wav");

        soundURL[9] = getClass().getResource("/sound/levelup.wav");
        soundURL[10] = getClass().getResource("/sound/heal_pool.wav");
